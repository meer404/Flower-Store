...
return [
    ...
    'delivery_outer_fee' => 'Outer Zone Delivery Fee',
    'delivery_outer_fee_hint' => 'Applied when distance exceeds the last tier. Leave 0 for free, or keep empty to block checkout.',
    'delivery_pricing' => 'Delivery Pricing',
    'delivery_pricing_hint' => 'Define distance tiers and fees for delivery calculation.',
    'distance_up_to_km' => 'Distance up to (km)',
    'delivery_fee_amount' => 'Fee',
    'delivery_map_title' => 'Delivery Pricing Map',
    'delivery_map_hint' => 'Drag the small markers on the map to set the distance for each tier.',
    'delivery_map_drag_hint' => 'Each circle represents a delivery tier radius from the store.',
    'delivery_map_radius_km' => 'Radius',
    'delivery_map_fee_label' => 'Fee',
    'delivery_outer_zone' => 'Outer zone fee applied',
