    ...
    <nav class="container mx-auto px-4 md:px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if (isLoggedIn()): ?>
                    <!-- Notifications -->
                    <a href="notifications.php" class="relative text-luxury-text hover:text-luxury-accent p-2">
                    ...
                    <!-- Shopping Cart -->
                    <a href="cart.php" class="relative text-luxury-text hover:text-luxury-accent p-2">
        ...
        <div id="mobileMenu" class="mobile-menu lg:hidden mt-4">
            <div class="bg-white border border-luxury-border rounded-lg shadow-lg p-4 space-y-3">
                ...
                <a href="index.php" class="block py-2 px-4 text-luxury-text hover:bg-luxury-accentLight rounded-lg">
                    <i class="fas fa-home mr-3"></i><?= e(t('nav_home')) ?>
                </a>
                <a href="shop.php" class="block py-2 px-4 text-luxury-text hover:bg-luxury-accentLight rounded-lg">
